...
creating_db = 0
if(creating_db):
    list_names_db = ["Manu","Ema","Kuba","Moni"]
    list_face_ids_db = []
    ...
    list_images_url_db = ["https://github.com/kubaex/faces/blob/master/Manuel4.jpg?raw=true",
                          ...
                          "https://github.com/manuwhs/Labyrinth/blob/master/internet_images/Monika.jpg?raw=true"] 
       # https://raw.githubusercontent.com/manuwhs/Labyrinth/master/internet_images/Monika.jpg
...
if(1):
    ...
    images_urls = ["https://github.com/manuwhs/Labyrinth/blob/master/internet_images/jury1.png?raw=true"]
...
#        time.sleep(20)
        ...
        for i in range(Npeople):
            ...
            ### Get the person that it is more likely to be. 
            probaility_aux = 0
            person = "None"
            for similar in result_similarity:
                if (similar["confidence"] > probaility_aux):
                    probaility_aux = similar["confidence"] 
                    person = faceId_to_name_dict[similar["persistedFaceId"]]
            prob_list.append(probaility_aux)
...
#        ax = plt.subplot2grid((2,3),(1, 2))
        ...
        for j in range(len(fr_list)):
            ...
            plt.text(origin[0], origin[1], "%s, %.2f"%(people_list[j], prob_list[j] ), fontsize=20, weight="bold", va="bottom")
        _ = plt.axis("off")
